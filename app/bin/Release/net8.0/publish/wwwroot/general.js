...
function tableToCSV() {
	...
	if (table) {
		...
		if (table.querySelector('tbody') && !table.querySelector('tbody h1')) {
			...
			a.href = url;
			a.download = "PTC-License-Tracker-OUTPUT.csv";
